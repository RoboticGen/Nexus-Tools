...
import { Copy, Download, Play, Save, Zap } from "lucide-react";
...
export const CodeEditor = forwardRef<CodeEditorHandle, CodeEditorProps>(
  ({ code, onChange, onRun, onRunInESP32, onCopy, onExport, onSaveToDevice, isConnected = false, className }, ref) => {
    const [tabs, setTabs] = useState<CodeTab[]>([{ id: "main", name: "test.py", code: code || "" }]);
    ...
    // otherwise-dark workspace. `OBO_CODE_CONFIG.theme` is a fixed `vs-light`.
