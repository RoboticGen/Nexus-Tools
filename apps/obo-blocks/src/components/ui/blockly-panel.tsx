...
/**
 * Panel wrapper for the Blockly visual editor: toolbar → workspace slot.
 *
 * The workspace is a slot: the design system does not depend on Blockly. The
 * consumer injects the workspace and this provides the themed chrome round it.
 */
