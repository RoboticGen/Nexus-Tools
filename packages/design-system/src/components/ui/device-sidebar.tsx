...
function DeviceSidebar({
  ...
  const toggleExpanded = () => {
    const next = !expanded
    // Writing internal state while controlled makes the two diverge the moment the consumer declines a toggle.
  ...
  return (
    <aside
      ...
      className={cn(
        ...
        // Only the width animates. `transition-all` also animates colour, so the whole sidebar cross-fades on every theme toggle.
