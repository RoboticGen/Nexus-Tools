...
type AlertProps = React.ComponentProps<"div"> & {
  ...
  tone?: Tone
  /** Leading icon. `true` (default) picks one from `tone`; pass an element for a custom icon, or `false` for none. */
  icon?: React.ReactNode | boolean
}

/** A stationary, always-visible message about the surrounding content — not a transient one. For something that appears and dismisses on its own, use `sonner`; for a confirmation the user must act on, use `AlertDialog`. */
