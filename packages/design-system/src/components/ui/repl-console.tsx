...
/** Interactive MicroPython REPL: scrollback, a command line, and the interrupt/reset/clear controls a REPL needs. */
function ReplConsole({
  ...
  const recall = (direction: -1 | 1) => {
    ...
    // Walking past the oldest entry with ↑ stays put; past the newest with ↓ clears the line, matching a shell history buffer.
