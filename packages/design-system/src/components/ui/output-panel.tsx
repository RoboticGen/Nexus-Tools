import { ConnectionStatus, type ConnectionState } from "@nexus-tools/design-system/components/ui/connection-status"
...
import { Terminal } from "@nexus-tools/design-system/components/ui/terminal"
...
type OutputPanelTab = {
  ...
  disabled?: boolean
  /** Requires a connected device. The tab stays reachable; its panel explains what is missing and offers the connect control. */
