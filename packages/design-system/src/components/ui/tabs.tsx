...
/** Inactive triggers use `text-muted-foreground`, not stock shadcn's `text-foreground/60`. At 60% our navy `--foreground` composites over the list's `bg-muted` to #627e8e — 3.88:1, an AA failure the a11y gate caught. */
